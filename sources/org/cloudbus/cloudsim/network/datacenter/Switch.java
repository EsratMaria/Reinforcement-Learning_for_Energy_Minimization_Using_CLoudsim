...
public class Switch extends SimEntity {
	...
	public PowerDatacenter powerDC;
	public Map<Integer, PowerHost> powerHostList;
	public SortedMap<Double, List<PowerHost>> powerFinTimeListHost = new TreeMap<Double, List<PowerHost>>();
	public SortedMap<Double, List<PowerVm>> powerFinTimeListVM = new TreeMap<Double, List<PowerVm>>();
	...
	/* I am writing to suit my env here */
	public Switch(String name, int level, PowerDatacenter powerDC) {
		super(name);
		this.level = level;
